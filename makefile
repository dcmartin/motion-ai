...
MARIADB_HOST ?= $(if $(wildcard MARIADB_HOST),$(shell v=$$(cat MARIADB_HOST) && echo "== MARIADB_HOST: $${v}" > /dev/stderr && echo "$${v}"),$(shell v="core-mariadb" && echo "** MARIADB_HOST unset; default: $${v}" > /dev/stderr && echo "$${v}"))
...
MOTION_DETECTED_PERSON_TUNE ?= $(if $(wildcard MOTION_DETECTED_PERSON_TUNE),$(shell v=$$(cat MOTION_DETECTED_PERSON_TUNE) && echo "== MOTION_DETECTED_PERSON_TUNE: $${v}" > /dev/stderr && echo "$${v}"),$(shell v='true' && echo "** MOTION_DETECTED_PERSON_TUNE unset; default: $${v}" > /dev/stderr && echo "$${v}"))
...
# tplink
TPLINK_DISCOVERY ?= $(if $(wildcard TPLINK_DISCOVERY),$(shell v=$$(cat TPLINK_DISCOVERY) && echo "== TPLINK_DISCOVERY: $${v}" > /dev/stderr && echo "$${v}"),$(shell v='true' && echo "** TPLINK_DISCOVERY unset; default: $${v}" > /dev/stderr && echo "$${v}"))
